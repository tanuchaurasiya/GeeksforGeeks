<h2><a href="https://www.geeksforgeeks.org/problems/connect-nodes-at-same-level/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Connect Nodes at Same Level</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p>Given a binary tree, connect the nodes that are at same level. You'll be given an addition&nbsp;<strong>nextRight&nbsp;</strong>pointer for the same.</p>
